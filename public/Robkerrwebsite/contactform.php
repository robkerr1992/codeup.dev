...
<body class="container-fluid contact-form-body">
            <!-- beginning of navbar -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-2">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="/robkerrwebsite/contactform.php">Contact</a></li>
    ...
    <h2>Contact</h2>
        <div class="login-form container col-md-4 col-md-offset-4">
            <form class="form-signin register-form">
                ...
                <label for="emailmessage" class="sr-only">Message</label>
                <textarea class="form-control" name="emailmessage" rows="8"></textarea>
                <div class="form-group">
